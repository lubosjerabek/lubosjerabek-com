...
<section class="section section--alt" id="experience">
    <div class="container">
        ...
        <div class="exp-stack">
            ...
            <article class="exp-card" style="--brand: #3d7a52">
                <button class="exp-header" aria-expanded="false">
                    <div class="exp-logo-wrap">
...
<?php
// Pick the first 3 recommendations for the homepage preview
$_recs_all     = json_decode(file_get_contents(__DIR__ . '/data/recommendations.json'), true) ?? [];
$_recs_preview = array_slice($_recs_all, 0, 3);
?>
<!-- ============================================================
...
<section class="section section--alt" id="recommendations">
    <div class="container">
        ...
        <p class="section-subtitle">What colleagues say about working with me.</p>

        <div class="rec-preview-grid">
            <?php foreach ($_recs_preview as $r): ?>
            <blockquote class="rec-preview-card">
                <p class="rec-preview-quote">&ldquo;<?= htmlspecialchars(mb_substr($r['text'], 0, 220)) ?>&hellip;&rdquo;</p>
                <footer class="rec-preview-credit">
        ...
        <div class="section-more">
            <a href="/recommendations.php" class="btn btn--outline">
                <span class="prompt">$</span> view-all-recommendations
            </a>
        </div>
    </div>
</section>
        ...
        <div class="contact-grid">
            ...
            <div>
                <div class="contact-links">
                    ...
                    <a class="contact-link" href="https://github.com/lubosjerabek" target="_blank" rel="noopener noreferrer">
                        <span class="contact-link__icon">
